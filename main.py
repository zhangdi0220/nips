...
def build_parser():
    ...
    parser.add_argument('--learning-rate', type=float,
                        ...
                        metavar='LEARNING_RATE', default=0.0001)

    parser.add_argument('--datapath', type=str,
                        dest='datapath', help='Path to CelebrityA dataset',
                        metavar='DATAPATH', default='./data/CelebA/Img/img_align_celeba/img_align_celeba/')

    parser.add_argument('--snapshot-dir', type=str,
                        dest='snapshot_dir', help='Where to save images and training metrics',
                        metavar='SNAPSHOT_DIR', default='./snapshot_dir/')
...
def main():
    ...
    with tf.Session() as sess:
        stego_net = StegoNet(sess, epochs=options.epochs, a=options.a, b=options.b, c=options.c,
                               ...
                               datapath=options.datapath, savepath=options.savepath, snapshot_dir=options.snapshot_dir)
